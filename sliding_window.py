...
def sliding_window(image, window_size, classifier: SVM, threshold=-0.5, step_size=(4, 4)):
...
if __name__ == '__main__':  
    ...
    img = cv2.imread("B:CS376_Images/assignment5/originalPics/2003/07/11/big/img_605.jpg")
