...
#greyscaled image
def sliding_window(image, window_size, classifier: SVM, threshold=0.0003, step_size=(8, 8)):
...
if __name__ == '__main__':  
    svm = SVM()
    svm.load_model('C:/Users/AaronLo/Documents/cs376/Computer-Vision-Final-Project/weights/weights_20231127_063053_epoch_85000.npz')
    
    img = cv2.imread("B:CS376_Images/assignment5/originalPics/2003/06/01/big/img_1396.jpg")
