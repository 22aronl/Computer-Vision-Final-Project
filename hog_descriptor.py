...
#needs gray scaled input patch, calcualtes teh magnitude and direction of the gradient
...
#needs the magnitude and direction of the gradient, calculates the histogram
...
#this gets the hog descriptor of the patch
